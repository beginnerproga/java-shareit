...
public class BookingControllerTest {
    ...
    @Test
    public void addBookingWithBadDateBadTest() throws Exception {
        BookingDto bookingDto = new BookingDto(1, 1, LocalDateTime.MAX.truncatedTo(ChronoUnit.SECONDS), LocalDateTime.now().plusHours(1).truncatedTo(ChronoUnit.SECONDS));
        long userId = 1;
        BookingInfoDto bookingInfoDto = new BookingInfoDto(bookingDto.getId(), bookingDto.getStart(), bookingDto.getEnd(), null, null, Status.WAITING);
    ...
    @Test
    public void addBookingStartAfterEndBadTest() throws Exception {
        BookingDto bookingDto = new BookingDto(1, 1, LocalDateTime.now().plusHours(30).truncatedTo(ChronoUnit.SECONDS), LocalDateTime.now().plusHours(1).truncatedTo(ChronoUnit.SECONDS));
        long userId = 1;
        BookingInfoDto bookingInfoDto = new BookingInfoDto(bookingDto.getId(), bookingDto.getStart(), bookingDto.getEnd(), null, null, Status.WAITING);
