...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(ItemDtoGateWay itemDto, Long userId) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> addComment(long itemId, Long userId, CommentDtoGateWay commentDto) {
        return post("/" + itemId + "/comment", userId, commentDto);
    }

    public ResponseEntity<Object> updateItem(ItemDtoGateWay itemDto, long itemId, Long userId) {
